...
<div class="btn-group">
	<button type="button" id="level5" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Fifth Level<i class="fas fa-caret-down"></i></button>
...
<div class="btn-group">
	<button type="button" id="level6" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sixth Level<i class="fas fa-caret-down"></i></button>
